...
let qid = ""
function get() {
    return Object.values(document.querySelector('#app > div > div'))[1].children[1]._owner.stateNode.state.question.correctAnswers[0]
}
let cor = "";
...
setInterval(()=>{
	if (document.querySelector("#app > div > div > div.arts__regularBody___1TM6E-camelCase > div.styles__questionContainer___3u_c9-camelCase > div")) {
      ...
      if (c.innerText == get()) {c.firstChild.click()}
    })
	}
